 ...
 * @author Majdi Rabie
 */
public class RowEmpHasProjController extends ListCell<Employee> {
	...
	public RowEmpHasProjController(StackPane pane, AnchorPane panerefr) {
		a = pane;
	...
	protected void updateItem(Employee employee, boolean empty) {
		...
		if (empty || employee == null) {
			...
			if (i.get(0) != null) {
				...
				lebelSkillId.setText(i.get(0).toString());
			...
			if (!(i.size() < 2)) {
				...
				levelSkillId2.setText(i.get(1).toString());
